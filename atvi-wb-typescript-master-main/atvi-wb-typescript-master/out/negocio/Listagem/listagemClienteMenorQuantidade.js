...
var ListagemMenosQuantidade = /** @class */ (function (_super) {
    __extends(ListagemMenosQuantidade, _super);
    function ListagemMenosQuantidade(cliente) {
        var _this = _super.call(this) || this;
        _this.cliente = cliente;
        return _this;
    }
    ListagemMenosQuantidade.prototype.listar = function () {
        var consumidores = [];
    ...
    return ListagemMenosQuantidade;
}(listagem_1.default));
exports.default = ListagemMenosQuantidade;
